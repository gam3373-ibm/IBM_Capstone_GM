...
df_launch_dict = pd.DataFrame.from_dict(launch_dict)
...
data_falcon9 = df_launch_dict.loc[df_launch_dict['BoosterVersion']!='Falcon 1']
...
#below 'python tip' does not keep the cell from producing the output. 
#just scroll down
